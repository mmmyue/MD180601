...
//                                                                             
//    Author:            Hua han                                                 
//    Company:           Pioneer Petrotech Services Inc.                                                       
//
//*****************************************************************************/
...
#define ECAN_ALL_ID		0x003
#define ECAN_PC_ID		0x005
#define ECAN_SIF_ID		0x007
#define ECAN_MD_ID		0x009
#define ECAN_UNIT_ID    ECAN_MD_ID       
